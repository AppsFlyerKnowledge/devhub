...
[block:parameters]
{
  "data": {
    ...
    "11-0": "`agency`",
    "11-1": "string",
    "11-2": "Filter by specific agency or multiple agencies.",
    "11-3": "`\"agency=agency-name\"`, `\"media_source=media-source-name&agency=agency-name\"`, `\"agency=agency-a,adency-b\"`",
...
[block:parameters]
{
  "data": {
    ...
    "11-1": "string",
    "11-2": "Filter by specific agency or multiple agencies.",
    "11-3": "`\"agency=agency-name\"`,`\"agency=agency-a,adency-b\"`",
    "12-0": "`additional_fields`",
    "12-1": "array",
    "12-2": "For the list of the additional fields and their description see the [Raw data field dictionary](https://support.appsflyer.com/hc/en-us/articles/208387843-Raw-data-field-dictionary#rawdata-fields-dictionary) table.",
