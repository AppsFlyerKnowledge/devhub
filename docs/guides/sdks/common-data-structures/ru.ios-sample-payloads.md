---
title: Пример полезных нагрузок iOS
slug: ios-пример полезных нагрузок
category:
  uri: SDK AppsFlyer
privacy:
