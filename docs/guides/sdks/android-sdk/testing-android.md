...
> **Note**
> 
> If you prefer not to use our recommended wizard you can find detailed instructions [here](https://dash.readme.com/project/hc/v0.1/docs/manual-testing-android)
